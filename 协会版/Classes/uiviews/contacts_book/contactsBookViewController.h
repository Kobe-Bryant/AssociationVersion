...
@interface contactsBookViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,IconDownloaderDelegate,CommandOperationDelegate,UAModalPanelDelegate,UISearchBarDelegate,UISearchDisplayDelegate,LoginViewDelegate> {
    ...
    MySearchDisplayController *searchDisplay;
