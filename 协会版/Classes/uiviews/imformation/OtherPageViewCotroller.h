...
@interface OtherPageViewCotroller : UIViewController<UITableViewDelegate,UITableViewDataSource,EGORefreshTableHeaderDelegate,IconDownloaderDelegate,CommandOperationDelegate,MBProgressHUDDelegate> {
