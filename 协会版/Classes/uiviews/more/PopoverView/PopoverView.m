...
#define kShadowAlpha 1.f

//Box gradient bg alpha
#define kBoxAlpha 1.f
...
#define colorGray   231.f

// BACKGROUND GRADIENT

//bottom color white in gradient bg
#define kGradientBottomColor [UIColor colorWithRed:colorGray/255.f green:colorGray/255.f blue:colorGray/255.f alpha:kBoxAlpha]//[UIColor colorWithWhite:0.980f alpha:kBoxAlpha]

//top color white value in gradient bg
#define kGradientTopColor [UIColor colorWithRed:colorGray/255.f green:colorGray/255.f blue:colorGray/255.f alpha:kBoxAlpha]//[UIColor colorWithWhite:1.f alpha:kBoxAlpha]


// TITLE GRADIENT

//bottom color white value in title gradient bg
#define kGradientTitleBottomColor [UIColor colorWithRed:colorGray/255.f green:colorGray/255.f blue:colorGray/255.f alpha:kBoxAlpha]//[UIColor colorWithWhite:0.93f alpha:kBoxAlpha]

//top color white value in title gradient bg
#define kGradientTitleTopColor [UIColor colorWithRed:colorGray/255.f green:colorGray/255.f blue:colorGray/255.f alpha:kBoxAlpha]//[UIColor colorWithWhite:1.f alpha:kBoxAlpha]
...
@synthesize delegate;
@synthesize upTagButton;
@synthesize downTagButton;
...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withContentView:(UIView *)cView {
    ...
    //新增一个上面遮罩按钮，点击隐藏弹出菜单
    if (self.upTagButton == nil) {
        self.upTagButton = [UIButton buttonWithType:UIButtonTypeCustom];
        self.upTagButton.backgroundColor = [UIColor clearColor];
        int contentY = contentView.frame.origin.y - 6;
        self.upTagButton.frame = CGRectMake(0, 0, window.frame.size.width, contentY);
    }
    [self.upTagButton addTarget:self action:@selector(dismiss) forControlEvents:UIControlEventTouchUpInside];
    [window addSubview:self.upTagButton];
    
    //新增一个下面遮罩按钮，点击隐藏弹出菜单
    if (downTagButton == nil) {
        self.downTagButton = [UIButton buttonWithType:UIButtonTypeCustom];
        self.downTagButton.backgroundColor = [UIColor clearColor];
        int contentY = contentView.frame.origin.y;
        int contentH = contentFrame.size.height;
        self.downTagButton.frame = CGRectMake(0, contentY+contentH, window.frame.size.width, window.frame.size.height - contentY - contentH);
        
    }
    [self.downTagButton addTarget:self action:@selector(dismiss) forControlEvents:UIControlEventTouchUpInside];
    [window addSubview:self.downTagButton];
...
- (void)drawRect:(CGRect)rect
{
    ...
    //// Shadow Declarations
    UIColor* shadow = [UIColor blackColor];//[UIColor colorWithWhite:0.f alpha:kShadowAlpha];
    ...
    //Draw the title background
    {
        ...
        if(titleBGHeight > 0.f) {
            ...
            //            [[UIColor colorWithRed:colorGray/255.f green:colorGray/255.f blue:colorGray/255.f alpha:1.f] setFill];
            //            [dividerLine fill];
