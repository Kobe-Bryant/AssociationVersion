...
@interface ShareToBlogViewController : UIViewController <UITextViewDelegate,WBEngineDelegate,OpenAPiDelegate,MBProgressHUDDelegate,SinaWeiboRequestDelegate,SinaWeiboDelegate,SinaWeiboRequestDelegate>{
